# Find the best hospital in a given state for a given "outcome", where "best" is
# the hospital with the lowest 30-day mortality rate for that outcome
#
...
best <- function(state, outcome) {
    ...
    return(as.character(data[sortOrder[1],1]))
}
